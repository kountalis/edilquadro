...
const CommercialServices = () => {
  const services = [
    ...
    { icon: <img src="/servizi-constructor.svg" alt="Servizi di costruzione" className="w-12 h-12" />, titleKey: 'service6_title', descKey: 'service6_desc', detailKeys: ['service6_detail1','service6_detail2','service6_detail3','service6_detail4'] },
  ];
