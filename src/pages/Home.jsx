            ...
            <div className="container mx-auto px-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                {services.map((service, index) => (
                  <div
                    key={index}
                    className="group bg-gradient-to-br from-gray-900/90 to-black/90 p-8 rounded-2xl shadow-xl border border-white/10 transform will-change-transform hover:shadow-2xl hover:scale-102 hover:-translate-y-0.5 transition-all duration-300 flex flex-col justify-between lazy-load-box"
            ...
            <div className="container mx-auto px-4">
              ...
              <div className="max-w-4xl mx-auto">
                {testimonials.map((testimonial, index) => (
                  <div
                    key={index}
                    className="group bg-gradient-to-br from-gray-900 to-gray-800 p-8 rounded-2xl shadow-xl mb-8 border border-gray-800 hover:border-green-500/20 hover:-translate-y-1.5 transition-all duration-300 relative overflow-hidden"
                  >
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 cta-actions-responsive">
                  ...
                  <a
                    ...
                    className="group relative px-8 py-5 rounded-2xl bg-gradient-to-r from-green-600 to-green-500 transition-all duration-300 hover:scale-102 hover:-translate-y-1 cta-action-btn"
